...
function ServicesSection() {
    return (
        <div>
            <div className='max-w-[1300px] mx-auto px-4 py-12 sm:py-8 lg:py-8'>
                <div className='mb-8 sm:mb-12 lg:mb-15 mx-auto flex flex-col justify-start gap-3'>
                    <h3 className='text-start bg-gradient-to-b from-[#c9f31d] to-[#272f06] text-black px-4 py-2 rounded text-sm sm:text-base font-medium inline-block mx-auto '>Services</h3>
