  ...
  return (
    <div className="flex justify-between items-center py-20">
      ...
      <div className="flex justify-end w-1/2">
       <img className="w-[400px] bg-black border border-[#c8f31d88] rounded-3xl rotate-5 hover:rotate-0 transition-transform duration-500 ease-in-out" src={mainProfile} alt="Profile"/>
      </div>
    </div>
  );
}
